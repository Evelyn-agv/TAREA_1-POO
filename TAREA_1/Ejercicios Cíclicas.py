class EstructuraCiclicas:     
    ...
    """Estructuras WHILE"""
    def estCic2(self):    #BUCLE CONTROLADO POR CONTADOR
        i=1
        while i<=100:
    ...
    def estCic3(self):    #BUCLE CONTROLADO POR CONDICIÓN
        sum=0
        prod=1
    ...
    def estCic4(self):    #BUCLE CONTROLADO POR CONDICIÓN
        sum=0
        prod=1
        num= int(input("Ingrese un número: "))
        while num!=-1:
    ...
    def estCic5(self):    #BUCLE CONTROLADO POR BANDERAS O INTERRUPTORES
        primo= True
        divisor=2
        num= int(input("Ingrese un número: "))
